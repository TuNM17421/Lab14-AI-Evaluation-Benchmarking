## Chunk 1
**ID**: access_control_sop_0
**Content**: Tài liệu này quy định quy trình cấp phép truy cập vào các hệ thống nội bộ của công ty.
Áp dụng cho tất cả nhân viên, contractor, và third-party vendor.

---

## Chunk 2
**ID**: access_control_sop_1
**Content**: Level 1 — Read Only:
...
## Chunk 3
**ID**: access_control_sop_2
**Content**: Bước 1: Nhân viên tạo Access Request ticket trên Jira (project IT-ACCESS).
...
## Chunk 4
**ID**: access_control_sop_3
**Content**: Escalation chỉ áp dụng khi cần thay đổi quyền hệ thống ngoài quy trình thông thường.
...
## Chunk 5
**ID**: access_control_sop_4
**Content**: Quyền phải được thu hồi trong các trường hợp:
...
## Chunk 6
**ID**: access_control_sop_5
**Content**: IT Security thực hiện access review mỗi 6 tháng.
Mọi bất thường phải được báo cáo lên CISO trong vòng 24 giờ.

---

## Chunk 7
**ID**: access_control_sop_6
**Content**: Ticket system: Jira (project IT-ACCESS)
IAM system: Okta
Audit log: Splunk
...
## Chunk 8
**ID**: hr_leave_policy_0
**Content**: 1.1 Nghỉ phép năm (Annual Leave):
...
## Chunk 9
**ID**: hr_leave_policy_1
**Content**: Bước 1: Nhân viên gửi yêu cầu nghỉ phép qua hệ thống HR Portal (https://hr.company.internal) ít nhất 3 ngày làm việc trước ngày nghỉ.
...
## Chunk 10
**ID**: hr_leave_policy_2
**Content**: 3.1 Điều kiện làm thêm:
...
## Chunk 11
**ID**: hr_leave_policy_3
**Content**: 4.1 Điều kiện remote:
...
## Chunk 12
**ID**: hr_leave_policy_4
**Content**: Email: hr@company.internal
Hotline: ext. 2000
...
## Chunk 13
**ID**: it_helpdesk_faq_0
**Content**: Q: Tôi quên mật khẩu, phải làm gì?
...
## Chunk 14
**ID**: it_helpdesk_faq_1
**Content**: Q: Phần mềm VPN nào công ty dùng?
...
## Chunk 15
**ID**: it_helpdesk_faq_2
**Content**: Q: Tôi cần cài phần mềm mới, phải làm gì?
...
## Chunk 16
**ID**: it_helpdesk_faq_3
**Content**: Q: Laptop mới được cấp sau bao lâu khi vào công ty?
...
## Chunk 17
**ID**: it_helpdesk_faq_4
**Content**: Q: Hộp thư đến đầy, phải làm gì?
...
## Chunk 18
**ID**: it_helpdesk_faq_5
**Content**: Hotline: ext. 9000 (8:00 - 18:00, Thứ 2 - Thứ 6)
...
## Chunk 19
**ID**: policy_refund_v4_0
**Content**: Chính sách này áp dụng cho tất cả các đơn hàng được đặt trên hệ thống nội bộ kể từ ngày 01/02/2026.
Các đơn hàng đặt trước ngày có hiệu lực sẽ áp dụng theo chính sách hoàn tiền phiên bản 3.

---

## Chunk 20
**ID**: policy_refund_v4_1
**Content**: Khách hàng được quyền yêu cầu hoàn tiền khi đáp ứng đủ các điều kiện sau:
...
## Chunk 21
**ID**: policy_refund_v4_2
**Content**: Hoàn tiền — Điều kiện áp dụng:
...
## Chunk 22
**ID**: policy_refund_v4_3
**Content**: Bước 1: Khách hàng gửi yêu cầu qua hệ thống ticket nội bộ với category "Refund Request".
...
## Chunk 23
**ID**: policy_refund_v4_4
**Content**: - Hoàn tiền qua phương thức thanh toán gốc: áp dụng trong 100% trường hợp đủ điều kiện.
...
## Chunk 24
**ID**: policy_refund_v4_5
**Content**: Email: cs-refund@company.internal
...
## Chunk 28
**ID**: sla_p1_2026_3
**Content**: Ticket system: Jira (project IT-SUPPORT)
...
## Chunk 29
**ID**: sla_p1_2026_4
**Content**: v2026.1 (2026-01-15): Cập nhật SLA P1 resolution từ 6 giờ xuống 4 giờ.
